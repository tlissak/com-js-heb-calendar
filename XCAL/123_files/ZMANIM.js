JDate.prototype.getZmanim = function(_O,_timedmc){
		if( typeof(_O) != "object" ){ 
			...
			//console.log("getZmanim(_O) _O is!object set Jerusalem / paris")
		}
	...
	function timeadj(_time) {
			var _hour = parseFloat(_time)//Math.floor(_time);
			var _min  = parseFloat(((_time - _hour) * 60.0)  )//+ 0.0) //Math.floor(((_time - _hour) * 60.0)  -0.6);
